...
INSERT INTO public.subjects (id, code, name_en, name_am, grade, stream, icon_asset, sort_order) VALUES ('math_g6', 'MATH6', 'Mathematics (Grade 6)', 'ሂሳብ', 6, 'general', 'assets/images/math_icon.png', 3) ON CONFLICT (id) DO UPDATE SET name_en=EXCLUDED.name_en, name_am=EXCLUDED.name_am;
INSERT INTO public.subjects (id, code, name_en, name_am, grade, stream, icon_asset, sort_order) VALUES ('science_g6', 'SCI6', 'Integrated Science (Grade 6)', 'የተቀናጀ ሳይንስ', 6, 'general', 'assets/images/science_icon.png', 4) ON CONFLICT (id) DO UPDATE SET name_en=EXCLUDED.name_en, name_am=EXCLUDED.name_am;
INSERT INTO public.subjects (id, code, name_en, name_am, grade, stream, icon_asset, sort_order) VALUES ('math_g8', 'MATH8', 'Mathematics (Grade 8)', 'ሂሳብ', 8, 'general', 'assets/images/math_icon.png', 5) ON CONFLICT (id) DO UPDATE SET name_en=EXCLUDED.name_en, name_am=EXCLUDED.name_am;
INSERT INTO public.subjects (id, code, name_en, name_am, grade, stream, icon_asset, sort_order) VALUES ('science_g8', 'SCI8', 'General Science (Grade 8)', 'አጠቃላይ ሳይንስ', 8, 'general', 'assets/images/science_icon.png', 6) ON CONFLICT (id) DO UPDATE SET name_en=EXCLUDED.name_en, name_am=EXCLUDED.name_am;
